...
const renderAddedtypeInfo = (templateType, correctAnswer) => {
  switch (templateType) {
    case 'MCMAQ': {
      return (
        <div className='margin-half--top'>
          <span className='margin-half--bottom' > Number of Correct Answers: </span>
          <InputNumber className='margin-half--bottom' value={correctAnswer?.MCMAQ?.correctNumber} onChange={(value) => this.onChange('correctNumber', value)} />
          ...
          <InputNumber className='margin-half--bottom' value={correctAnswer?.MCMAQ?.incorrectNumber} onChange={(value) => this.onChange('incorrectNumber', value)} />
          <div className='margin--ends'>
            {
    ...
    case 'textual': {
      return (
        <div className='margin-half--top'>
          ...
          <Input className='margin-half--bottom' value={correctAnswer?.textual?.text} onChange={(e) => this.onChange('text', e.target.value)} />
        </div>
      )
    }
    case 'numerical': {
      return (
        <div className='margin-half--top'>
          ...
          <Input className='margin-half--bottom' value={correctAnswer?.textual?.tolerance} onChange={(e) => this.onChange('tolerance', e.target.value)} />
          <div className='margin-half--bottom' > Unit (optional): </div>
          <Input className='margin-half--bottom' value={correctAnswer?.textual?.unit} onChange={(e) => this.onChange('unit', e.target.value)} />
        </div>
      )
    }
    default:
